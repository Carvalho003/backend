...
(1, 'Instagram', 'Pedido com embalagem especial para presente', 29.9, 0.32, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), 1, 22),
(2, 'Mercado Livre', 'Personalização com frase enviada por WhatsApp', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 4 DAY), 1, DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 14 DAY), 2, 22),
(3, 'Shopee', 'Pedido com tema Breaking Bad personalizado', 99.8, 1.09, DATE_ADD(NOW(), INTERVAL 5 DAY), 1, DATE_SUB(NOW(), INTERVAL 21 DAY), DATE_SUB(NOW(), INTERVAL 21 DAY), 3, 4),
(4, 'WhatsApp', 'Entrega combinada via motoboy', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 6 DAY), 1, DATE_SUB(NOW(), INTERVAL 28 DAY), DATE_SUB(NOW(), INTERVAL 28 DAY), 4, 22),
(5, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 144.7, 0.9, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 35 DAY), DATE_SUB(NOW(), INTERVAL 35 DAY), 5, 22),
(6, 'Site', 'Pedido com tema Breaking Bad personalizado', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 8 DAY), 1, DATE_SUB(NOW(), INTERVAL 42 DAY), NOW(), 6, 4),
(7, 'Mercado Livre', 'Produto será utilizado em casamento', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 9 DAY), 1, DATE_SUB(NOW(), INTERVAL 49 DAY), DATE_SUB(NOW(), INTERVAL 49 DAY), 7, 22),
(8, 'Shopee', 'Pedido liberado após confirmação de pagamento', 159.6, 0.92, DATE_ADD(NOW(), INTERVAL 10 DAY), 1, DATE_SUB(NOW(), INTERVAL 56 DAY), DATE_SUB(NOW(), INTERVAL 56 DAY), 8, 2),
(9, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 84.8, 0.79, DATE_ADD(NOW(), INTERVAL 11 DAY), 1, DATE_SUB(NOW(), INTERVAL 63 DAY), DATE_SUB(NOW(), INTERVAL 63 DAY), 9, 4),
(10, 'WhatsApp', 'Pedido com tema Breaking Bad personalizado', 164.6, 1.34, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 70 DAY), DATE_SUB(NOW(), INTERVAL 70 DAY), 10, 2),
...
(12, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 6 DAY), 1, DATE_SUB(NOW(), INTERVAL 84 DAY), NOW(), 12, 4),
(13, 'Site', 'Cliente pediu alteração nas cores da arte', 72.8, 0.49, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 0 DAY), DATE_SUB(NOW(), INTERVAL 0 DAY), 13, 2),
(14, 'Shopee', 'Produto será utilizado em casamento', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 4 DAY), 1, DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), 14, 2),
(15, 'Mercado Livre', 'Pedido com tema Breaking Bad personalizado', 134.6, 1.3, DATE_ADD(NOW(), INTERVAL 1 DAY), 1, DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 14 DAY), 15, 4),
(16, 'Instagram', 'Cliente aprovou mockup sem alterações', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 6 DAY), 1, DATE_SUB(NOW(), INTERVAL 21 DAY), DATE_SUB(NOW(), INTERVAL 21 DAY), 16, 2),
(17, 'Mercado Livre', 'Pedido com embalagem especial para presente', 29.9, 0.32, DATE_ADD(NOW(), INTERVAL 4 DAY), 1, DATE_SUB(NOW(), INTERVAL 28 DAY), DATE_SUB(NOW(), INTERVAL 28 DAY), 17, 2),
(18, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 124.7, 0.7, DATE_ADD(NOW(), INTERVAL 8 DAY), 1, DATE_SUB(NOW(), INTERVAL 35 DAY), NOW(), 18, 4),
(19, 'Shopee', 'Cliente pediu urgência na produção', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 9 DAY), 1, DATE_SUB(NOW(), INTERVAL 42 DAY), DATE_SUB(NOW(), INTERVAL 42 DAY), 19, 2),
(20, 'WhatsApp', 'Pedido com tema Breaking Bad personalizado', 119.7, 1, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 49 DAY), DATE_SUB(NOW(), INTERVAL 49 DAY), 20, 2),
...
(22, 'Shopee', 'Cliente pediu alteração nas cores da arte', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 12 DAY), 1, DATE_SUB(NOW(), INTERVAL 63 DAY), DATE_SUB(NOW(), INTERVAL 63 DAY), 22, 2),
(23, 'Site', 'Cliente pediu urgência na produção', 149.6, 1.32, DATE_ADD(NOW(), INTERVAL 13 DAY), 1, DATE_SUB(NOW(), INTERVAL 70 DAY), DATE_SUB(NOW(), INTERVAL 70 DAY), 23, 2),
(24, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 119.7, 1, DATE_ADD(NOW(), INTERVAL 4 DAY), 1, DATE_SUB(NOW(), INTERVAL 77 DAY), NOW(), 24, 4),
(25, 'WhatsApp', 'Pedido com tema Breaking Bad personalizado', 169.6, 1.04, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 84 DAY), DATE_SUB(NOW(), INTERVAL 84 DAY), 25, 2),
(26, 'Site', 'Pedido com embalagem especial para presente', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 4 DAY), 1, DATE_SUB(NOW(), INTERVAL 0 DAY), DATE_SUB(NOW(), INTERVAL 0 DAY), 26, 2),
...
(28, 'Site', 'Personalização com frase enviada por WhatsApp', 104.8, 0.54, DATE_ADD(NOW(), INTERVAL 6 DAY), 1, DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 14 DAY), 28, 2),
(29, 'Mercado Livre', 'Pedido liberado após confirmação de pagamento', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 7 DAY), 1, DATE_SUB(NOW(), INTERVAL 21 DAY), DATE_SUB(NOW(), INTERVAL 21 DAY), 29, 2),
(30, 'Site', 'Pedido com tema Breaking Bad personalizado', 119.7, 1, DATE_ADD(NOW(), INTERVAL 1 DAY), 1, DATE_SUB(NOW(), INTERVAL 28 DAY), NOW(), 30, 4),
(31, 'WhatsApp', 'Cliente aprovou mockup sem alterações', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 9 DAY), 1, DATE_SUB(NOW(), INTERVAL 35 DAY), DATE_SUB(NOW(), INTERVAL 35 DAY), 1, 2),
(32, 'Site', 'Cliente pediu alteração no tamanho da estampa', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 10 DAY), 1, DATE_SUB(NOW(), INTERVAL 42 DAY), DATE_SUB(NOW(), INTERVAL 42 DAY), 2, 2),
(33, 'Mercado Livre', 'Pedido com tema Breaking Bad personalizado', 119.7, 1, DATE_ADD(NOW(), INTERVAL 11 DAY), 1, DATE_SUB(NOW(), INTERVAL 49 DAY), DATE_SUB(NOW(), INTERVAL 49 DAY), 3, 4),
(34, 'Shopee', 'Pedido com embalagem especial para presente', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 7 DAY), 1, DATE_SUB(NOW(), INTERVAL 56 DAY), DATE_SUB(NOW(), INTERVAL 56 DAY), 4, 2),
(35, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 184.6, 2.16, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 63 DAY), DATE_SUB(NOW(), INTERVAL 63 DAY), 5, 2),
(36, 'Mercado Livre', 'Pedido com tema Breaking Bad personalizado', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 70 DAY), NOW(), 6, 4),
...
(38, 'Shopee', 'Cliente pediu acabamento fosco', 114.8, 0.58, DATE_ADD(NOW(), INTERVAL 4 DAY), 1, DATE_SUB(NOW(), INTERVAL 84 DAY), DATE_SUB(NOW(), INTERVAL 84 DAY), 8, 2),
(39, 'Mercado Livre', 'Pedido com tema Breaking Bad personalizado', 72.8, 0.49, DATE_ADD(NOW(), INTERVAL 5 DAY), 1, DATE_SUB(NOW(), INTERVAL 0 DAY), DATE_SUB(NOW(), INTERVAL 0 DAY), 9, 4),
(40, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 119.7, 1, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), 10, 2),
...
(42, 'Site', 'Pedido com tema Breaking Bad personalizado', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 8 DAY), 1, DATE_SUB(NOW(), INTERVAL 21 DAY), NOW(), 12, 4),
(43, 'Instagram', 'Cliente pediu alteração no tamanho da estampa', 84.8, 0.52, DATE_ADD(NOW(), INTERVAL 9 DAY), 1, DATE_SUB(NOW(), INTERVAL 28 DAY), DATE_SUB(NOW(), INTERVAL 28 DAY), 13, 2),
(44, 'Mercado Livre', 'Personalização com frase enviada por WhatsApp', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 10 DAY), 1, DATE_SUB(NOW(), INTERVAL 35 DAY), DATE_SUB(NOW(), INTERVAL 35 DAY), 14, 2),
(45, 'WhatsApp', 'Pedido com tema Breaking Bad personalizado', 164.6, 1.34, DATE_ADD(NOW(), INTERVAL 1 DAY), 1, DATE_SUB(NOW(), INTERVAL 42 DAY), DATE_SUB(NOW(), INTERVAL 42 DAY), 15, 4),
(46, 'Instagram', 'Pedido com personalização minimalista', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 12 DAY), 1, DATE_SUB(NOW(), INTERVAL 49 DAY), DATE_SUB(NOW(), INTERVAL 49 DAY), 16, 2),
...
(48, 'Shopee', 'Pedido com tema Breaking Bad personalizado', 104.7, 0.98, DATE_ADD(NOW(), INTERVAL 7 DAY), 1, DATE_SUB(NOW(), INTERVAL 63 DAY), NOW(), 18, 4),
(49, 'WhatsApp', 'Arte revisada pelo setor de criação', 119.7, 1, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 70 DAY), DATE_SUB(NOW(), INTERVAL 70 DAY), 19, 2),
(50, 'Site', 'Pedido com tema Breaking Bad personalizado', 164.6, 1.34, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 77 DAY), DATE_SUB(NOW(), INTERVAL 77 DAY), 20, 2),
(51, 'Shopee', 'Cliente pediu ajuste de nome na arte', 29.9, 0.32, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 84 DAY), DATE_SUB(NOW(), INTERVAL 84 DAY), 21, 4),
(52, 'Instagram', 'Pedido com personalização minimalista', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 6 DAY), 1, DATE_SUB(NOW(), INTERVAL 0 DAY), DATE_SUB(NOW(), INTERVAL 0 DAY), 22, 2),
...
(54, 'WhatsApp', 'Pedido com tema Breaking Bad personalizado', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 8 DAY), 1, DATE_SUB(NOW(), INTERVAL 14 DAY), NOW(), 24, 4),
(55, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 149.6, 1.32, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 21 DAY), DATE_SUB(NOW(), INTERVAL 21 DAY), 25, 2),
(56, 'Mercado Livre', 'Pedido para evento interno da empresa', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 10 DAY), 1, DATE_SUB(NOW(), INTERVAL 28 DAY), DATE_SUB(NOW(), INTERVAL 28 DAY), 26, 2),
...
(58, 'Shopee', 'Produto destinado a presente de formatura', 189.6, 1.68, DATE_ADD(NOW(), INTERVAL 12 DAY), 1, DATE_SUB(NOW(), INTERVAL 42 DAY), DATE_SUB(NOW(), INTERVAL 42 DAY), 28, 2),
(59, 'Instagram', 'Pedido com embalagem especial para presente', 99.8, 1.09, DATE_ADD(NOW(), INTERVAL 13 DAY), 1, DATE_SUB(NOW(), INTERVAL 49 DAY), DATE_SUB(NOW(), INTERVAL 49 DAY), 29, 2),
(60, 'WhatsApp', 'Pedido com tema Breaking Bad personalizado', 189.6, 1.77, DATE_ADD(NOW(), INTERVAL 1 DAY), 1, DATE_SUB(NOW(), INTERVAL 56 DAY), NOW(), 30, 4),
...
(62, 'Mercado Livre', 'Cliente pediu ajuste de nome na arte', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 4 DAY), 1, DATE_SUB(NOW(), INTERVAL 70 DAY), DATE_SUB(NOW(), INTERVAL 70 DAY), 2, 2),
(63, 'Shopee', 'Pedido com tema Breaking Bad personalizado', 119.7, 1, DATE_ADD(NOW(), INTERVAL 5 DAY), 1, DATE_SUB(NOW(), INTERVAL 77 DAY), DATE_SUB(NOW(), INTERVAL 77 DAY), 3, 4),
(64, 'Site', 'Pedido com identidade visual da empresa', 104.8, 0.54, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 84 DAY), DATE_SUB(NOW(), INTERVAL 84 DAY), 4, 2),
(65, 'Mercado Livre', 'Pedido com tema Breaking Bad personalizado', 144.7, 0.9, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 0 DAY), DATE_SUB(NOW(), INTERVAL 0 DAY), 5, 2),
(66, 'Shopee', 'Pedido com tema Breaking Bad personalizado', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 8 DAY), 1, DATE_SUB(NOW(), INTERVAL 7 DAY), NOW(), 6, 4),
...
(68, 'Mercado Livre', 'Cliente pediu alteração no tamanho da estampa', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 6 DAY), 1, DATE_SUB(NOW(), INTERVAL 21 DAY), DATE_SUB(NOW(), INTERVAL 21 DAY), 8, 2),
(69, 'WhatsApp', 'Pedido com tema Breaking Bad personalizado', 104.7, 0.98, DATE_ADD(NOW(), INTERVAL 11 DAY), 1, DATE_SUB(NOW(), INTERVAL 28 DAY), DATE_SUB(NOW(), INTERVAL 28 DAY), 9, 4),
(70, 'Site', 'Pedido com tema Breaking Bad personalizado', 169.6, 1.14, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 35 DAY), DATE_SUB(NOW(), INTERVAL 35 DAY), 10, 2),
...
(72, 'Site', 'Pedido com tema Breaking Bad personalizado', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 49 DAY), NOW(), 12, 4),
(73, 'Shopee', 'Cliente pediu alteração nas cores da arte', 114.8, 0.58, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 56 DAY), DATE_SUB(NOW(), INTERVAL 56 DAY), 13, 2),
(74, 'Mercado Livre', 'Pedido com identidade visual da empresa', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 4 DAY), 1, DATE_SUB(NOW(), INTERVAL 63 DAY), DATE_SUB(NOW(), INTERVAL 63 DAY), 14, 2),
(75, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 114.7, 1.11, DATE_ADD(NOW(), INTERVAL 1 DAY), 1, DATE_SUB(NOW(), INTERVAL 70 DAY), DATE_SUB(NOW(), INTERVAL 70 DAY), 15, 4),
(76, 'Mercado Livre', 'Cliente pediu alteração nas cores da arte', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 7 DAY), 1, DATE_SUB(NOW(), INTERVAL 77 DAY), DATE_SUB(NOW(), INTERVAL 77 DAY), 16, 2),
...
(78, 'WhatsApp', 'Pedido com tema Breaking Bad personalizado', 72.8, 0.49, DATE_ADD(NOW(), INTERVAL 8 DAY), 1, DATE_SUB(NOW(), INTERVAL 0 DAY), NOW(), 18, 4),
(79, 'Site', 'Cliente enviou referência de arte pelo Instagram', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 9 DAY), 1, DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), 19, 2),
(80, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 134.7, 1.02, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 14 DAY), 20, 2),
...
(82, 'WhatsApp', 'Cliente enviou referência de arte pelo Instagram', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 12 DAY), 1, DATE_SUB(NOW(), INTERVAL 28 DAY), DATE_SUB(NOW(), INTERVAL 28 DAY), 22, 2),
(83, 'Mercado Livre', 'Entrega programada para feira escolar', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 13 DAY), 1, DATE_SUB(NOW(), INTERVAL 35 DAY), DATE_SUB(NOW(), INTERVAL 35 DAY), 23, 2),
(84, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 42 DAY), NOW(), 24, 4),
(85, 'Mercado Livre', 'Pedido com tema Breaking Bad personalizado', 234.5, 0.98, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 49 DAY), DATE_SUB(NOW(), INTERVAL 49 DAY), 25, 2),
(86, 'Site', 'Pedido para lembrança de evento corporativo', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 4 DAY), 1, DATE_SUB(NOW(), INTERVAL 56 DAY), DATE_SUB(NOW(), INTERVAL 56 DAY), 26, 2),
...
(88, 'Instagram', 'Cliente pediu alteração no tamanho da estampa', 229.6, 1.16, DATE_ADD(NOW(), INTERVAL 5 DAY), 1, DATE_SUB(NOW(), INTERVAL 70 DAY), DATE_SUB(NOW(), INTERVAL 70 DAY), 28, 2),
(89, 'Mercado Livre', 'Pedido com tema pet e nome personalizado', 154.7, 1.84, DATE_ADD(NOW(), INTERVAL 7 DAY), 1, DATE_SUB(NOW(), INTERVAL 77 DAY), DATE_SUB(NOW(), INTERVAL 77 DAY), 29, 2),
(90, 'Shopee', 'Pedido com tema Breaking Bad personalizado', 119.7, 1, DATE_ADD(NOW(), INTERVAL 1 DAY), 1, DATE_SUB(NOW(), INTERVAL 84 DAY), NOW(), 30, 4),
...
(92, 'Mercado Livre', 'Pedido para lembrança de evento corporativo', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 10 DAY), 1, DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), 2, 2),
(93, 'Site', 'Pedido com tema Breaking Bad personalizado', 134.7, 1.02, DATE_ADD(NOW(), INTERVAL 11 DAY), 1, DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 14 DAY), 3, 4),
(94, 'Shopee', 'Pedido com personalização minimalista', 119.7, 1, DATE_ADD(NOW(), INTERVAL 12 DAY), 1, DATE_SUB(NOW(), INTERVAL 21 DAY), DATE_SUB(NOW(), INTERVAL 21 DAY), 4, 2),
(95, 'Mercado Livre', 'Pedido com tema Breaking Bad personalizado', 129.7, 1.41, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 28 DAY), DATE_SUB(NOW(), INTERVAL 28 DAY), 5, 2),
(96, 'Shopee', 'Pedido com tema Breaking Bad personalizado', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 35 DAY), NOW(), 6, 4),
...
(98, 'WhatsApp', 'Produto destinado a presente de formatura', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 4 DAY), 1, DATE_SUB(NOW(), INTERVAL 49 DAY), DATE_SUB(NOW(), INTERVAL 49 DAY), 8, 2),
(99, 'Mercado Livre', 'Pedido com tema Breaking Bad personalizado', 104.7, 0.98, DATE_ADD(NOW(), INTERVAL 5 DAY), 1, DATE_SUB(NOW(), INTERVAL 56 DAY), DATE_SUB(NOW(), INTERVAL 56 DAY), 9, 4),
(100, 'Site', 'Pedido com tema Breaking Bad personalizado', 209.5, 1.68, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 63 DAY), DATE_SUB(NOW(), INTERVAL 63 DAY), 10, 2),
...
(102, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 5 DAY), 1, DATE_SUB(NOW(), INTERVAL 77 DAY), NOW(), 12, 4),
(103, 'Site', 'Entrega para aniversário no fim de semana', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 9 DAY), 1, DATE_SUB(NOW(), INTERVAL 84 DAY), DATE_SUB(NOW(), INTERVAL 84 DAY), 13, 2),
(104, 'Instagram', 'Cliente pediu urgência na produção', 104.7, 0.98, DATE_ADD(NOW(), INTERVAL 10 DAY), 1, DATE_SUB(NOW(), INTERVAL 0 DAY), DATE_SUB(NOW(), INTERVAL 0 DAY), 14, 2),
(105, 'Site', 'Pedido com tema Breaking Bad personalizado', 119.7, 1, DATE_ADD(NOW(), INTERVAL 1 DAY), 1, DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), 15, 4),
(106, 'Shopee', 'Entrega para aniversário no fim de semana', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 12 DAY), 1, DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 14 DAY), 16, 2),
(107, 'WhatsApp', 'Pedido com embalagem especial para presente', 99.8, 1, DATE_ADD(NOW(), INTERVAL 13 DAY), 1, DATE_SUB(NOW(), INTERVAL 21 DAY), DATE_SUB(NOW(), INTERVAL 21 DAY), 17, 2),
(108, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 84.8, 0.52, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 28 DAY), NOW(), 18, 4),
...
(110, 'Site', 'Pedido com tema Breaking Bad personalizado', 134.7, 1.02, DATE_ADD(NOW(), INTERVAL 3 DAY), 1, DATE_SUB(NOW(), INTERVAL 42 DAY), DATE_SUB(NOW(), INTERVAL 42 DAY), 20, 2),
...
(112, 'Mercado Livre', 'Pedido liberado após confirmação de pagamento', 44.9, 0.34, DATE_ADD(NOW(), INTERVAL 6 DAY), 1, DATE_SUB(NOW(), INTERVAL 56 DAY), DATE_SUB(NOW(), INTERVAL 56 DAY), 22, 2),
(113, 'Instagram', 'Produto destinado a presente de formatura', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 7 DAY), 1, DATE_SUB(NOW(), INTERVAL 63 DAY), DATE_SUB(NOW(), INTERVAL 63 DAY), 23, 2),
(114, 'Mercado Livre', 'Pedido com tema Breaking Bad personalizado', 84.8, 0.79, DATE_ADD(NOW(), INTERVAL 8 DAY), 1, DATE_SUB(NOW(), INTERVAL 70 DAY), NOW(), 24, 4),
(115, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 114.7, 1.11, DATE_ADD(NOW(), INTERVAL 2 DAY), 1, DATE_SUB(NOW(), INTERVAL 77 DAY), DATE_SUB(NOW(), INTERVAL 77 DAY), 25, 2),
(116, 'Mercado Livre', 'Cliente pediu ajuste de nome na arte', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 5 DAY), 1, DATE_SUB(NOW(), INTERVAL 84 DAY), DATE_SUB(NOW(), INTERVAL 84 DAY), 26, 2),
(117, 'Instagram', 'Pedido com tema Breaking Bad personalizado', 89.8, 0.68, DATE_ADD(NOW(), INTERVAL 11 DAY), 1, DATE_SUB(NOW(), INTERVAL 0 DAY), DATE_SUB(NOW(), INTERVAL 0 DAY), 27, 4),
(118, 'Site', 'Cliente pediu acabamento fosco', 74.8, 0.66, DATE_ADD(NOW(), INTERVAL 12 DAY), 1, DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY), 28, 2),
(119, 'Mercado Livre', 'Cliente pediu revisão ortográfica da frase', 104.7, 0.98, DATE_ADD(NOW(), INTERVAL 1 DAY), 1, DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 14 DAY), 29, 2),
(120, 'WhatsApp', 'Pedido com tema Breaking Bad personalizado', 119.7, 1, DATE_ADD(NOW(), INTERVAL 1 DAY), 1, DATE_SUB(NOW(), INTERVAL 21 DAY), NOW(), 30, 4);
...
(67, 1, DATE_SUB(NOW(), INTERVAL 65 DAY), DATE_SUB(NOW(), INTERVAL 64 DAY), 63, 21),
...
(86, 1, DATE_SUB(NOW(), INTERVAL 13 DAY), DATE_SUB(NOW(), INTERVAL 12 DAY), 81, 21),
...
(112, 1, DATE_SUB(NOW(), INTERVAL 14 DAY), DATE_SUB(NOW(), INTERVAL 13 DAY), 106, 21),
