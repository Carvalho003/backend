...
import school.sptech.EncantoPersonalizados.entities.dashboardFinanceiro.DashboardVendas;
...
public interface DashboardVendasRepository extends JpaRepository<DashboardVendas, Long> {
    ...
    @Query("SELECT new school.sptech.EncantoPersonalizados.dto.dashboardFinanceiro.CategoriaDTO(v.nomeCategoria, SUM(v.valorTotalVendido)) " +
